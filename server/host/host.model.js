...
const hostSchema = new mongoose.Schema(
  {
    ...
    coverImage: { type: String, default: "https://hearttoheart.hearthaven.club/storage/coverImage.jpg" },
    ...
    videoType: { type: Number, enum: [0, 1], default: 0 },
    imageType: { type: Number, enum: [0, 1], default: 0 },
  },
  {
    timestamps: true,
    versionKey: false,
