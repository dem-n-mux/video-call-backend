    ...
    if (host) {
      payload = {
        ...
        notification: {
          ...
          body: `Dear ${host?.name}, we are pleased to inform you that your redeem request has been successfully processed.`,
        },
      };
    }

    if (host && !host.isBlock && host.fcm_token !== null) {
    ...
    if (req.query.type === "accept") {
      ...
      payload = {
        ...
        notification: {
          ...
          body: `Dear ${host?.name}, Your redeem request has been successfully processed.`,
        },
        data: {
          type: "REDEEM",
        },
      ...
      payload = {
        token: host?.fcm_token,
        notification: {
          title: "Redeem Request Declined",
          body: "Unfortunately, your redeem request has been declined. Please contact support for further assistance.",
        },
        data: {
          type: "REDEEM",
        },
